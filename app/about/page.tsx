...
import { buildAboutPage, buildGraph } from '@/lib/schema'

export default function AboutPage() {
  const founder = getPrimaryAuthor()
  const aboutSchema = buildAboutPage()
  const jsonLd = buildGraph([aboutSchema])
    ...
    <div className="divide-y divide-gray-200 dark:divide-gray-700">
      ...
      <div className="prose dark:prose-invert max-w-none pt-10 pb-12">
        ...
        <section aria-labelledby="trust-heading">
          ...
          <ul>
            <li>
              <strong>Source Verification:</strong> Where appropriate, articles are informed by
              official documentation, primary sources, reputable industry publications, documented
              evaluation notes, and editorial review.
            </li>
            <li>
