...
At its core, a robot is a programmable machine designed to carry out a complex series of physical actions automatically or semi-automatically. The defining characteristic of a robot is its physicality. Software that trades stocks on Wall Street is not a robot. A robotic arm welding a car door on an assembly line _is_ a robot.
